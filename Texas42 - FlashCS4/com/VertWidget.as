package com
{
	...
	public class VertWidget extends MovieClip
	{
		...
		public function createlist(_selectionArray:Array):void
		{
			...
			next_btn.x = txtFieldWidth / 2;
			next_btn.y = txtFieldbkgd.height + 5;
			next_btn.addEventListener(MouseEvent.CLICK, onNext);
			
			prev_btn.x = txtFieldWidth / 2;
		...
		private function onNext(e:MouseEvent):void
		{
			...
			{
				currectSelection++;
				newY = newY - scrollDist;
				var myTween:Tween = new Tween(number_mc, "y", Strong.easeOut, number_mc.y, newY, .5, true);
			}
			buttonView();
		}
