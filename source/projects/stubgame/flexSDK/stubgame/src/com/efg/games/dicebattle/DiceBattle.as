package com.efg.games.dicebattle
{
	...
	public class DiceBattle extends Game
	{
		...
		private static const Y_PAD:int = 		75; //chnaged
		private static const X_PAD:int = 		150; //chnaged
		private static const ROW_SPACING:int = 	4; //chnaged
		private static const COL_SPACING:int = 	4; //chnaged
		private static const DIE_HEIGHT:int	=	50; //chnaged
		private static const DIE_WIDTH:int	=	50; //chnaged
		private static const DIE_ROWS:int   = 	5; //chnaged
		private static const DIE_COLS:int   = 	6; //chnaged
			
		private static const CHAR_WIDTH:int = 64; //chnaged
		private static const CHAR_HEIGHT:int= 64; //chnaged
