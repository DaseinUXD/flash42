...
//	import com.mwm.framework.Domino;
...
*/
		const domW:int = 50; //domino width constant
		static const domH:int = 100; //domino height constant
		...
		public var domOutline:Shape; //domino outline
...
*/	   
			// Domino Outline
			domOutline.graphics.lineStyle (1, 1, 1);
			...
			domDot.x = 50;
			domDot.y = 25;
			domino.addChild (domDot);
			
			domino.x = domX;
			domino.y = domY;
			trace (domino.x, domino.y);
			stag.addChild (domDot);
